...
Magisk > Install module MagiskHide Props Config > Conceal app icon and package name > settings > configure deny list > select <package_name>
+
Frida > multi bypass script
=============================
## Generic Test Cases:
